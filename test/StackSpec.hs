...
testStackInsertAtLocation = 
  TestCase $ 
    assertEqual 
      "stackInsertAtLocation should return a new stack with item x inserted at location y (starting from 0)"
      (Stack [1,2,3,6,4])
      (stackInsertAtLocation 3 6 (Stack [1,2,3,4]))
